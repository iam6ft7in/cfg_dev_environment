---
name: new-repo
description: Create a complete gold standard GitHub repository from scratch, including scaffold, resume batch file, branch protection, GitHub Projects board, topics, and labels.
---
...
### 3o. Create Resume Batch Files
The `resume_claude.bat` is already in the repo (copied from the scaffold in 3d and
...
session. This is what the resume bat uses — keep the session name and bat file in sync."
...
Repository created successfully.
  ...
  Resume bat: {local_path}\resume_claude.bat
           + %USERPROFILE%\OneDrive\scripts\resume-{repo_name}.bat
